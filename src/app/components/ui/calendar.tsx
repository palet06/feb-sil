  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-accent text-white hover:bg-accent-hover hover:text-white focus:bg-accent focus:text-white dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today:
